...
var _initBurger = require("./modules/init-burger");
var _initColorsSlider = require("./modules/init-colors-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    (0, _initColorsSlider.initColorsSlider)();
  });
});

},{"./modules/form-validate/form":94,"./modules/init-burger":100,"./modules/init-colors-slider":101,"./utils/ios-vh-fix":103}],93:[function(require,module,exports){
"use strict";
...
var baseSuccessCallback = function baseSuccessCallback(event) {
  ...
  var formResponse = document.querySelector('.form__response');
  formResponse.style.display = 'block';
  formResponse.innerHTML = "\u0424\u043E\u0440\u043C\u0430 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430<br>".concat(Object.entries(formData).map(function (_ref) {
    var _ref2 = _slicedToArray(_ref, 2),
      key = _ref2[0],
      value = _ref2[1];
    return "".concat(key, ": ").concat(value, "<br>");
  }).join(''));
};
...
},{"./callback":93,"./init-phone-input":95,"./validator":99}],95:[function(require,module,exports){
"use strict";
...
},{"./matrix":96,"./regular-expression":97,"./render-message":98}],100:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initBurger = void 0;
var initBurger = exports.initBurger = function initBurger() {
  var SCREEN_TABLET = 768;
  var pageBody = document.querySelector('body');
  var headerNav = document.querySelector('[data-header-nav]');
  var burgerButton = document.querySelector('[data-burger]');
...
exports.initColorsSlider = void 0;
var _swiper = _interopRequireWildcard(require("swiper"));
function _interopRequireWildcard(e, t) { if ("function" == typeof WeakMap) var r = new WeakMap(), n = new WeakMap(); return (_interopRequireWildcard = function _interopRequireWildcard(e, t) { if (!t && e && e.__esModule) return e; var o, i, f = { __proto__: null, default: e }; if (null === e || "object" != _typeof(e) && "function" != typeof e) return f; if (o = t ? n : r) { if (o.has(e)) return o.get(e); o.set(e, f); } for (var _t in e) "default" !== _t && {}.hasOwnProperty.call(e, _t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, _t)) && (i.get || i.set) ? o(f, _t, i) : f[_t] = e[_t]); return f; })(e, t); }
_swiper.default.use([_swiper.Pagination, _swiper.Lazy]);
var initColorsSlider = exports.initColorsSlider = function initColorsSlider() {
  var sliderContainers = document.querySelectorAll('[data-colors-slider-container]');
  if (sliderContainers.length === 0) {
    return;
  }
  sliderContainers.forEach(function (sliderContainer) {
    var slider = sliderContainer.querySelector('[data-colors-slider]');
    var bulletClasses = sliderContainer.dataset.bulletClasses ? sliderContainer.dataset.bulletClasses.split(',') : [];
    ...
    new _swiper.default(slider, {
      ...
      pagination: {
        ...
        renderBullet: function renderBullet(index, className) {
          ...
          var customClass = bulletClasses[index] || '';
          return "<span class=\"".concat(className, " ").concat(customClass, "\"></span>");
        }
      }
    });
  });
...
},{"swiper":91}],102:[function(require,module,exports){
"use strict";
